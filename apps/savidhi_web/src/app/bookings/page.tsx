...
import { Flame, Clock, LogIn, Loader2 } from 'lucide-react';
import { isAuthenticated } from '@/lib/auth';
import { pujaBookingService, appointmentService } from '@/lib/services';
    ...
    <div className="section-container py-8 max-w-2xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Link href="/bookings/puja" className="card p-6 hover:shadow-md transition group">
          ...
          <p className="text-xs text-text-secondary mt-1">{pujaCount} bookings</p>
        </Link>
        ...
        <Link href="/bookings/appointments" className="card p-6 hover:shadow-md transition group">
          ...
          <p className="text-xs text-text-secondary mt-1">{apptCount} bookings</p>
        </Link>
      </div>
    </div>
  );
